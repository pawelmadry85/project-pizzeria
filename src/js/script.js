...

{
  ...
  class Cart{
    ...
    getElements(element){
      ...
      thisCart.dom.phone = document.querySelector(select.cart.phone); //dodanie do metody getElements wlasciwosci dla inputow na numer tel.
      // console.log(thisCart.dom.phone);

      thisCart.dom.address = document.querySelector(select.cart.address); //dodanie do metody getElements wlasciwosci dla inputow na adres
